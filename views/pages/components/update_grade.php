<div class="modal fade" id="update_grade_modal" tabindex="-1">
            ...
            <form action="javascript:void(0)" id="update_grade_form">
                <div class="modal-body">
                    ...
                    <div class="actual-form">
                        ...
                        <div class="alert alert-danger text-center d-none" id="update_grade_error">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                <label for="update_grade_student_id" class="fw-semibold">Student</label>
                                <select class="form-control" id="update_grade_student_id" required>
                            ...
                            <div class="col-lg-6">
                                <label for="update_grade_subject" class="fw-semibold">Subject</label>
                                <select class="form-control" id="update_grade_subject" required>
                                    <!-- Data on AJAX -->
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <label for="update_grade_final" class="fw-semibold">Final Grade</label>
                                <input type="number" min="0" max="100" step="0.01" class="form-control" id="update_grade_final" placeholder="Not Yet Available" readonly>
                            </div>
                            <div class="col-lg-6">
                                <label for="update_grade_remarks" class="fw-semibold">Remarks</label>
                                <input type="text" class="form-control" id="update_grade_remarks" placeholder="Not Yet Available" readonly>
                            </div>
                        </div>
